...
export class GraphDataService {
  ...
  getFilteredData(caseId: string, patientId: string) {
    //Filter Outcomes Data with the given caseId and Patient ID and return it
    return [];
  }

  // getGraphData(outcomesData: OutcomesData[]) {
  //   return [
